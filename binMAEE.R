#####################################################################################
# GEE analysis of cluster randomized trials with binary responses
...
binMAEE=function(y, X, id, n, Z, maxiter, epsilon, 
  ...
  # Note that one could easily program the analytical inverse R_i^{-1} given in the paper
  # to reduce the computational burden associated with large cluster sizes; 
  # Here, we numerically invert the correlation matrix, as this function is developed for 
  # general purposes and works for other correlation structures as well
